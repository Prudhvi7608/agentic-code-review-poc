...
2. For each issue, first highlight the mistaken part (quote the problematic line or section and include the line number), then provide a suggestion, and then show the corrected code in a Python code block immediately after your suggestion.
